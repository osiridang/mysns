...
export function BackgroundImageManager({ selectedImageUrl, onSelectImage, accessToken, bgColor, onColorChange }: BackgroundImageManagerProps) {
  ...
  const handleSelect = (image: BackgroundImage) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="mb-4">
        <h3 className="font-semibold text-gray-900 mb-2">배경 이미지 관리</h3>
        <p className="text-sm text-gray-600">
          배경 이미지를 업로드하고 관리하세요. 카드뉴스의 배경으로 사용할 수 있습니다.
        </p>
      </div>
      ...
      {onColorChange && (
        <div className="mb-6 pb-6 border-b border-gray-200">
          <h4 className="font-medium text-gray-900 mb-3">배경색</h4>
      ...
      {loading ? (
        ...
        <div className="text-center py-8 text-gray-500 border-2 border-dashed rounded-lg mb-4">
          <Upload className="w-12 h-12 mx-auto mb-2 text-gray-400" />
          <p>업로드된 배경 이미지가 없습니다.</p>
          <p className="text-xs mt-1">아래 업로드 버튼을 눌러 추가하세요.</p>
        </div>
      ) : (
